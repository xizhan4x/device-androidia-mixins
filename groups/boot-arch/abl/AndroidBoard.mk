...
$(hide) $(ACP) -f $(BOARD_BLDR_SECOND_STAGE_BIN) $(BOARD_BOOTLOADER_DIR)/$(1)/out/fastboot.bin
mkext2img  $(BOARD_BOOTLOADER_VAR_IMG) $(BOARD_BOOTLOADER_BLOCK_SIZE) $(BOARD_BOOTLOADER_PARTITION_SIZE) $(BOARD_BOOTLOADER_DIR)/$(1)/out
